...
#from   rosalind  import LabelledTree,hamming_distance


def print_assignments(result_tree):
            ...
            for edge in result_tree.edges[node]:
                ...
                if node in result_tree.labels and end in result_tree.labels:
                    print('{0}->{1}:{2}'.format(result_tree.labels[node],
                                                ...
                                                hamming_distance(result_tree.labels[node], result_tree.labels[end])))
